      ...
      <div className="post">
        ...
        <div className="post__buttons">
          ...
          <InputOption
            ...
            color="gray"
          />
          <InputOption Icon={ShareOutlinedIcon} title="" color="gray" />
          <InputOption Icon={SendOutlinedIcon} title="" color="gray" />
        </div>
