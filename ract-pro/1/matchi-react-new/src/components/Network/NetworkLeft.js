  ...
  render() {
    return (
      <div className="network_left" style={{ marginTop: "45px" }}>
        ...
        <div className="network_left__stats" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div className="network_left__stat" style={{ textAlign: "right", marginTop: "20px" }}>
            <p className="network_left__statNumber" style={{ display: "inline-block", textAlign: "left" }}>{this.state.followers}</p>
          </div>
          <div className="network_left__stat" style={{ marginTop: "20px" }}>
            <p style={{ display: "inline-block" }}>دنبال کننده ها</p>
          </div>
        </div>
