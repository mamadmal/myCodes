...
class Profile extends Component {
  ...
  render() {
    ...
    const { cover_pic } = this.state;
    const coverPhotoSrc = cover_pic ? cover_pic : './images/cover.jpeg';
    ...
    return (
      <div className="profile">
        ...
        <div className="profile__top">
          ...
          <img src={coverPhotoSrc} alt="background" />
          ...
          <div className="profile__stats main-div" style={{ marginTop: "-10px" }}>
                ...
                <React.Fragment>
                  ...
                  <Typography className="profile__stat_connections">
                    {this.state.no_of_followers > 1 ? (
                      ...
                      >
                        {this.state.no_of_followers} ارتباط گرفتید
                      </span>
                    ) : (
                      <span style={{ fontWeight: "bold", fontSize: "16px" }}>
                        {this.state.no_of_followers} ارتباط ها
                      </span>
                    )}
                  </Typography>
                </React.Fragment>
            ...
            <div className="profile__stat">
              <Button style={open_to}>
                <span style={{ fontWeight: "bold" }}>ورود به</span>
              </Button>
              <Button style={profile_button}>
                <span style={{ fontWeight: "bold" }}>افزودن به پروفایل</span>
              </Button>
              <Button style={profile_button}>
                <span style={{ fontWeight: "bold" }}>بیشتر</span>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="profile__about mt-3">
          <div className="profile__about_header d-flex justify-content-between">
            ...
            />
            <span style={{ fontSize: "25px" }}>درباره</span>
        ...
        <div className="profile__dashboard">
          <span
            style={{ fontSize: "25px" }}
            className="profile__dashboard_header d-flex justify-content-right dash-span"
          >
            داشبورد شما
          </span>
          <span
          ...
          <div className="profile__dashboard_card_1">
            کسانی که پروفایل شما را دیدند
          </div>
          <div className="profile__dashboard_card_2">کسانی که پست های شما را دیدند</div>
        </div>
        ...
        <div className="profile__activity">
          <div className="profile__activity_header d-flex justify-content-between">
            <span style={{ fontSize: "25px" }}>فعالیت ها</span>
            ...
            >
              <span style={{ fontWeight: "bold" }}>نوشتن پست</span>
            </Button>
          ...
          <div className="pl-2">
            ...
            >
               پست هایی که ساختید در اینجا نمایش داده میشود
            </span>
          </div>
          <div>
            <Link
            ...
            >
              ...
              >
                <span style={{ fontWeight: "bold" }}>مشاهده تمام فعالیت ها</span>
              </Button>
            </Link>
          </div>
        </div>
        ...
        <div className="profile__skills">
          ...
          <BiPlus
              style={{ fontSize: "40px" }}
              onClick={() => this.onSkillModal(true)}
            />
            <Button
              className="mr-left"
              size="small"
...
<span style={{ fontSize: "25px" }} className="mr-auto skills-btn">
              مهارت ها
            </span>
          </div>
