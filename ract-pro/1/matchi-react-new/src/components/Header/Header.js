    ...
    return (
      <Container style={{ position: "fixed" }}>
        <Content>
          <Logo>
            <a href="/">
              <img src="/images/home-logo.svg" alt=""  className="home-logo"/>
            </a>
          </Logo>
          <Search className="search-icon">
            <div>
              <input type="text" placeholder="جستوجو" className="txt-box"/>
            </div>
            <SearchIcon>
            ...
            <NavListWrap>
              ...
              >
                <Link onClick={this.thisClicked} to={"/"}>
                  ...
                  <span onClick={this.thisClicked}>خانه</span>
                </Link>
              </NavList>
              ...
              >
                <Link onClick={this.thisClicked} to={"/network"}>
                  ...
                  <span onClick={this.thisClicked}>شبکه من</span>
                </Link>
              </NavList>
